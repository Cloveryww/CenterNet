...
# test
python test.py ctdet --exp_id coco_dla_bill_res18  --dataset coco_bill  --resume --arch res_18 --load_model /home/xiejinluo/yww/CenterNet/exp/ctdet/coco_dla_bill_res18/model_best.pth
